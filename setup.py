...
setup(
    name='ico',
    version='0.1',
    description="Contratos Inteligentes Ethereum - Crowdsales ",
    long_description=readme + '\n\n' + history,
    author="Rafael Ribeiro",
    author_email='rafael.ribeiro@coinmarketbrasil.com.br',
    url='https://coinmarketbrasil.com.br',
    packages=[
        'ico',
    ],
    package_dir={'ico':
    ...
    license="Apache 2.0",
    zip_safe=False,
    keywords='Contratos Inteligentes em Ethereum Sao os mais consolidados',
    classifiers=[
